...
public class SarahTimings {
	...
	public static void main(String[] args)
	{
		...
		addRandomNumbersToList( "arrayList", arrayList, 100000 );
		checkListsForContainsRandomNumber( "arrayList", arrayList, 1000 );
		addRandomNumbersToList( "linkedList", linkedList, 100000 );
		checkListsForContainsRandomNumber( "linkedList", linkedList, 10000);
		addRandomNumbersToList( "singlyLinkedList", singlyLinkedList, 100000 );
